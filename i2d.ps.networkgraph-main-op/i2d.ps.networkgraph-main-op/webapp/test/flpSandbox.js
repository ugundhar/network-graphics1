		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ProjectNetworkGraph-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProjectNetworkGraph-display": {
								"semanticObject": "ProjectNetworkGraph",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=i2d.ps.networkgraph",
									"url": sap.ui.require.toUrl("i2d/ps/networkgraph")
								}
							}
						}
					}
